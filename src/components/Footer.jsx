      ...
      <div className="max-w-screen-xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-5 text-zinc-400">
            {/* GitHub */}
            <a href="https://github.com/Amikzz" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition transform hover:scale-110">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com/in/amika-subasinghe-a52b6a1a9" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition transform hover:scale-110">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Email */}
            <a href="mailto:amikasubasinghe@gmail.com" className="hover:text-blue-400 transition transform hover:scale-110">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
