    ...
    <main className="w-full min-h-screen bg-zinc-900 text-zinc-50 flex flex-col items-center justify-start pt-40 px-6 md:px-20 relative">
      ...
      <div className="max-w-6xl w-full flex flex-col gap-10">
        ...
        >
          ...
          <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            from Colombo, Sri Lanka, with a strong foundation in full-stack
            development. I love turning ideas into practical digital solutions
            and have hands-on experience across desktop, web, and mobile
            applications. I thrive in collaborative environments, constantly
            learning and applying new technologies to build efficient,
            user-friendly, and impactful solutions. My long-term goal is to
            become a professional software engineer and eventually start my own
            company, delivering innovative applications that make a real
            difference.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="list-disc list-inside space-y-2 text-zinc-300">
            <p className="text-zinc-300 leading-relaxed mb-4">
              In my current role, I lead large-scale projects that enhance
              operational efficiency and drive digital transformation. I’ve
              developed systems for production, machinery, and IT infrastructure
              management, implemented an HR solution using OrangeHRM, and
              conducted business analyses to identify and address
              inefficiencies. These initiatives have allowed me to combine
              technical expertise with strategic analysis to deliver innovative,
              impactful organizational improvements.
            </p>
          </ul>

          <div className="mt-4 flex flex-wrap gap-2">
            <span className="bg-zinc-700 text-cyan-400 px-3 py-1 rounded-full text-sm font-medium">
              C#
            </span>
            <span className="bg-zinc-700 text-cyan-400 px-3 py-1 rounded-full text-sm font-medium">
              C++
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 mt-5">
            <div>
              <h3 className="text-lg font-bold text-white">
                Software Development and Management Trainee
              </h3>
              <p className="text-cyan-400 font-medium">
          ...
          <ul className="list-disc list-inside space-y-2 text-zinc-300">
            <p className="text-zinc-300 leading-relaxed mb-4">
              During my internship, I gained practical experience in system
              development and analysis, contributing to projects that improved
              operational efficiency and supported digital transformation. I
              developed systems for invoicing and vehicle management, and
              optimized existing platforms like QuickBooks and Brylix ERP. These
              experiences strengthened my technical, analytical, and
              problem-solving skills in creating scalable software solutions.
            </p>
          </ul>
        ...
        >
          ...
          <ul className="space-y-6 text-zinc-300">
            <li className="flex flex-col md:flex-row md:justify-between md:items-start gap-1">
              ...
              <span className="text-sm text-cyan-400 md:mt-0 mt-1">
                (2023 - Present)
              </span>
            </li>
            ...
            <li className="flex flex-col md:flex-row md:justify-between md:items-start gap-1">
              <div className="flex flex-col">
                ...
                <span className="text-zinc-400">University of Moratuwa</span>
              </div>
              <span className="text-sm text-cyan-400 md:mt-0 mt-1">
                (2025 - Present)
              </span>
        ...
        >
          ...
          <ul className="space-y-4 text-zinc-300">
            ...
            <li className="flex flex-col gap-1">
              ...
              <span className="text-zinc-400 text-sm">
                Flutter + Laravel + MySQL with real-time tracking and ticketing.
              </span>
            </li>
            <li className="flex flex-col gap-1">
              <span className="font-semibold text-white">
                Invoicing & Order Management System
              </span>
              <span className="text-zinc-400 text-sm">
                Laravel-based, reduced processing time by 70%.
              </span>
            </li>
            <li className="flex flex-col gap-1">
              <span className="font-semibold text-white">
            ...
            <li className="flex flex-col gap-1">
              <span className="font-semibold text-white">
                Stock & Library Management Systems
              </span>
              <span className="text-zinc-400 text-sm">
                CRUD apps with C# and SQL Server.
              </span>
            </li>
            <li className="flex flex-col gap-1">
              <span className="font-semibold text-white">
        ...
        >
          ...
          <ul className="space-y-4 text-zinc-300">
            ...
            <li className="flex flex-col gap-1">
              <span className="font-semibold text-white">
                Presentation Merit Award
              </span>
              <span className="text-zinc-400 text-sm">
                National Convention of Student’s Quality Circle
              </span>
            </li>
          </ul>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-4 text-zinc-300">
            <li className="flex flex-col gap-1">
              ...
              <span className="text-zinc-400 text-sm">
                Full Stack Computer Society (APIIT)
              </span>
            </li>
            <li className="flex flex-col gap-1">
        ...
        >
          ...
          <ul className="space-y-4 text-zinc-300">
            <li className="flex flex-col gap-1">
              <span className="font-semibold text-white">
                Mr. Vipula Anandapiya
              </span>
              <span className="text-zinc-400 text-sm">
                Director - Adlux Software
              </span>
      ...
      >
        <a
          href={cvFile}
          download
          className="bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-3 rounded-xl flex items-center gap-2 shadow-lg"
        >
