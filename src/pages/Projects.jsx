...
const ProjectListItem = ({ project, index }) => {
  return (
    <motion.div
      ...
      className="group relative border-t border-zinc-200 dark:border-zinc-800 transition-colors duration-300"
    >
      <Link
      ...
      >
        ...
        <div className="relative z-30 px-6 md:px-12 lg:px-24 py-12 md:py-16 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-start md:items-center gap-6 md:gap-12">
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold font-cabinet text-zinc-900 dark:text-white group-hover:translate-x-4 transition-transform duration-500 ease-out">
              {project.title}
            </h2>
          </div>
          ...
          <div className="flex items-center gap-8 md:gap-16">
            <div className="hidden md:flex flex-col items-end gap-1">
              ...
              <span className="text-zinc-600 dark:text-zinc-300 group-hover:text-zinc-900 dark:group-hover:text-white transition-colors text-base font-medium">
                {project.tech[0]} &bull; {project.tech[1]}
              </span>
            </div>

            {/* Arrow Icon */}
            <div className="text-zinc-900 dark:text-white text-2xl md:text-3xl opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
              <FaArrowRight />
            </div>
          </div>
        </div>
...
const Projects = () => {
  return (
    <main className="w-full min-h-screen bg-white dark:bg-[#111111] text-zinc-900 dark:text-white pt-32 pb-20 relative font-syne cursor-default">
      <SEO
      ...
      <div className="px-6 md:px-12 lg:px-24 mb-20 lg:mb-32">
        ...
        >
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold text-zinc-900 dark:text-white mb-8 tracking-tighter leading-[0.9] font-syne">
            Selected <br />
